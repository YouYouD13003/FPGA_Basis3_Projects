...
#set_property PACKAGE_PIN K19 [get_ports QspiCSn]					
	#set_property IOSTANDARD LVCMOS33 [get_ports QspiCSn]## This file is a general .xdc for the Basys3 rev B board
## To use it in a project:
## - uncomment the lines corresponding to used pins
## - rename the used ports (in each line, after get_ports) according to the top level signal names in the project
...
set_property PACKAGE_PIN U18 [get_ports RST]						
	set_property IOSTANDARD LVCMOS33 [get_ports RST]
#set_property PACKAGE_PIN T18 [get_ports BUT_UP]						
	#set_property IOSTANDARD LVCMOS33 [get_ports BUT_UP]
set_property PACKAGE_PIN W19 [get_ports BUT_LEFT]						
	set_property IOSTANDARD LVCMOS33 [get_ports BUT_LEFT]
set_property PACKAGE_PIN T17 [get_ports BUT_RIGHT]						
	set_property IOSTANDARD LVCMOS33 [get_ports BUT_RIGHT]
#set_property PACKAGE_PIN U17 [get_ports BUT_DOWN]						
	#set_property IOSTANDARD LVCMOS33 [get_ports BUT_DOWN]
